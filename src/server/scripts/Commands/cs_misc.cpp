...
public:
    ...
    */
    ...
    static bool HandleCharDisplayHandsCommand(ChatHandler* handler, const char* args) //袪袔小褤袪褦袪褢, 袪褩袪褧袪褦袪掳袪露袪褢小鈥毿犅?小袃袪袉袪褧袪褢 小袀小褤袪褦袪褢!
    {
        if (!*args)
            return false;
        char* cId = handler->extractKeyFromLink((char*) args, "Hitem");
    ...
    static bool HandleCharDisplayBackCommand(ChatHandler* handler,const char* args) //袪袔小褤袪褦袪褢, 袪褩袪褧袪褦袪掳袪露袪褢小鈥毿犅?小袃袪袉袪褧袪褢 小袀小褤袪褦袪褢!
    {
        if (!*args)
            return false;
        char* cId = handler->extractKeyFromLink((char*) args, "Hitem");
    ...
    static bool HandleCharDisplayOffhandCommand(ChatHandler* handler, const char* args) //袪袔小褤袪褦袪褢, 袪褩袪褧袪褦袪掳袪露袪褢小鈥毿犅?小袃袪袉袪褧袪褢 小袀小褤袪褦袪褢!
    {
        if (!*args)
            return false;
        char* cId = handler->extractKeyFromLink((char*) args, "Hitem");
    ...
    static bool HandleCharDisplayRangedCommand(ChatHandler* handler, const char* args) //袪袔小褤袪褦袪褢, 袪褩袪褧袪褦袪掳袪露袪褢小鈥毿犅?小袃袪袉袪褧袪褢 小袀小褤袪褦袪褢!
    {
        if (!*args)
            return false;
        char* cId = handler->extractKeyFromLink((char*) args, "Hitem");
    ...
    static bool HandleCharDisplayTabardCommand(ChatHandler* handler, const char* args) //袪袔小褤袪褦袪褢, 袪褩袪褧袪褦袪掳袪露袪褢小鈥毿犅?小袃袪袉袪褧袪褢 小袀小褤袪褦袪褢!
    {
        if(!*args)
            return false;
        char* cId = handler->extractKeyFromLink((char*)args,"Hitem");
    ...
    static bool HandleCharDisplayShirtCommand(ChatHandler* handler, const char* args) //袪袔小褤袪褦袪褢, 袪褩袪褧袪褦袪掳袪露袪褢小鈥毿犅?小袃袪袉袪褧袪褢 小袀小褤袪褦袪褢!
    {
        if(!*args)
            return false;
        char* cId = handler->extractKeyFromLink((char*)args,"Hitem");
