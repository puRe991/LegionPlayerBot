...
void BattlegroundMgr::CreateInitialBattlegrounds()
{
    ...
    do
    {
        ...
        data.MinPlayersPerTeam = fields[5].GetUInt32();
...
{
    _brawlTemplatesContainer[0] = BrawlData(MS::Battlegrounds::BattlegroundTypeId::BrawlBattlegroundWarsongScramble, 257, 322, "PvP Brawl: Warsong scramle", "1", "2", MS::Battlegrounds::BrawlTypes::Battleground); // 239
    _brawlTemplatesContainer[1] = BrawlData(MS::Battlegrounds::BattlegroundTypeId::BrawlBattlegroundShadoPan, 268, 329, "PvP Brawl: Shado-Pan Showdown", "3", "4", MS::Battlegrounds::BrawlTypes::Lfg); // 240

    // temp
    _brawlTemplatesContainer[2] = BrawlData(MS::Battlegrounds::BattlegroundTypeId::BrawlBattlegroundArathiBasinWinter, 262, 321, "PvP Brawl: Arathi Blizzard", "5", "0", MS::Battlegrounds::BrawlTypes::Battleground); // 240
    _brawlTemplatesContainer[3] = BrawlData(MS::Battlegrounds::BattlegroundTypeId::BrawlEyeOfStorm, 255, 324, "PvP Brawl: Gravity Lapse", "6", "1", MS::Battlegrounds::BrawlTypes::Battleground); // 239
    //

    _brawlTemplatesContainer[4] = BrawlData(MS::Battlegrounds::BattlegroundTypeId::BrawlArenaAll, 265, 327, "PvP Brawl: Packed House", "7", "2", MS::Battlegrounds::BrawlTypes::Arena); // 239
    ...
    _brawlTemplatesContainer[6] = BrawlData(MS::Battlegrounds::BattlegroundTypeId::BrawlAllSix, 267, 348, "Brawl: the magnificent six", "8", "3", MS::Battlegrounds::BrawlTypes::Battleground); // 240
    _brawlTemplatesContainer[7] = BrawlData(MS::Battlegrounds::BattlegroundTypeId::BrawlBattlegroundArathiBasinWinter, 262, 321,"PvP Brawl: Arathi Blizzard", "9", "4", MS::Battlegrounds::BrawlTypes::Battleground); // 240
    _brawlTemplatesContainer[8] = BrawlData(MS::Battlegrounds::BattlegroundTypeId::BrawlEyeOfStorm, 255, 324, "PvP Brawl: Gravity Lapse", "10", "5", MS::Battlegrounds::BrawlTypes::Battleground); // 239
